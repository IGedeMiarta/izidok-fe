<template>
    <div class="app-wrapper bg-secondary">
        <div class="app-main">
                            ...
                            <div class="hero-wrapper bg-composed-wrapper min-vh-100">
                                <div class="flex-grow-1 w-100 d-flex align-items-center">
                                    <div class="col-lg-6 px-4 mx-auto text-center text-black">
                                        <img src="@/assets/img/illustrations/505.svg" class="w-50 mx-auto d-block my-5 img-fluid" alt="">
                                        ...
                                        <p>
                                            We've been automatically alerted of the issue and will work to fix it as soon as possible.
                                        </p>

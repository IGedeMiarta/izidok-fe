<template>
    <div class="row">
        <div class="col-lg-4">
            <div class="card card-box-alt card-border-top border-success mb-5 pb-4">
                ...
                <a href="javascript:void(0);" class="btn btn-link btn-link-first mb-2 p-0" title="Find out more">
        ...
        <div class="col-lg-4">
            <div class="card card-box-alt card-border-top border-warning mb-5 pb-4">

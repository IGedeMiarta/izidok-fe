<template>
  <div class="vdatetime-calendar">
    ...
    <div class="vdatetime-calendar__month">
      <div class="vdatetime-calendar__month__weekday" v-for="(weekday, wIndex) in weekdays" :key="wIndex">{{ weekday }}</div>
      <div class="vdatetime-calendar__month__day" v-for="(day, dIndex) in days" :key="dIndex" @click="selectDay(day)" :class="{'vdatetime-calendar__month__day--selected': day.selected, 'vdatetime-calendar__month__day--disabled': day.disabled}">

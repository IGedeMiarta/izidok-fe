<template>
  <div>
    ...
    <div class="col-md-4">
      ...
      <b-button @click='drawBackground' variant="primary" size="sm" class="m-1">Image</b-button>
    </div>
...
export default {
  ...
  methods:{
    drawBackground(){
      ...
      let backgroundURL = "https://cdn.glitch.com/4c9ebeb9-8b9a-4adc-ad0a-238d9ae00bb5%2Fmdn_logo-only_color.svg?1535749917189";

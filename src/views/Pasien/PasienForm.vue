<template>
  ...
  <div>
    <div class="text-center col-md-12 foto-upload mb-4" v-if="formType !== 'detail'">
    ...
    <b-form v-on:submit.prevent="submitForm">
      ...
      <div class="form-row">
        <b-form-group label="No. KTP" class="text-capitalize col-md-6 pr-3" style="position: relative"
            ...
            <b-col cols="6">
              <b-form-group :label="renderLabel({ label: 'tempat lahir' })" class="text-capitalize"
                ...
                <b-form-input @keyup="
                  ...
                  " :state="getDataError({ rawLabel: 'tempat lahir' })" :disabled="disabledForm()"
                  :value="getValue('tempat lahir')" :maxlength="30" />
              </b-form-group>
            </b-col>
            <b-col cols="6">
        ...
        <b-col cols="6">
          <b-form-group :label="renderLabel({ label: 'nama penjamin/asuransi' })" class="text-capitalize"
            ...
            <b-form-input @keyup="
              ...
              " :disabled="disabledForm()" :value="getValue('nama penjamin/asuransi')" :maxlength="30" />
          </b-form-group>
        </b-col>
      </div>
      <div class="form-row">
      ...
      <b-row class="mb-3">
        <b-col cols="6">
          <b-row>
            <b-col cols="6">
              <b-form-group label="RT" class="text-capitalize" style="position: relative"
                :state="getDataError({ rawLabel: 'rt' })" :invalid-feedback="
                  renderInvalidFeedback({
                    validationDesc: blindlyGetData({
                      rawLabel: 'rt'
                    })
                ...
                <b-form-input @keypress="
                  ...
                  " :disabled="disabledForm()" :value="getValue('rt')" :maxlength="10" />
              </b-form-group>
            </b-col>
            <b-col cols="6">
              <b-form-group label="RW" class="text-capitalize" style="position: relative"
                :state="getDataError({ rawLabel: 'rw' })" :invalid-feedback="
                  renderInvalidFeedback({
                    validationDesc: blindlyGetData({
                      rawLabel: 'rw'
                    })
                ...
                <b-form-input @keypress="
                  ...
                  " :disabled="disabledForm()" :value="getValue('rw')" :maxlength="10" />
              </b-form-group>
            </b-col>
            <b-col cols="6">
              <b-form-group label="Kel/Desa" class="text-capitalize" style="position: relative"
                :state="getDataError({ rawLabel: 'kel/desa' })" :invalid-feedback="
                  renderInvalidFeedback({
                    validationDesc: blindlyGetData({
                      rawLabel: 'kel/desa'
                    })
                ...
                <b-form-input @keyup="
                  ...
                  " :disabled="disabledForm()" :value="getValue('kel/desa')" :maxlength="20" />
              </b-form-group>
            </b-col>
            <b-col cols="6">
              <b-form-group label="Kecamatan" class="text-capitalize" style="position: relative"
                :state="getDataError({ rawLabel: 'kecamatan' })" :invalid-feedback="
                  renderInvalidFeedback({
                    validationDesc: blindlyGetData({
                      rawLabel: 'kecamatan'
                    })
                ...
                <b-form-input @keyup="
                  ...
                  " :disabled="disabledForm()" :value="getValue('kecamatan')" :maxlength="20" />
              </b-form-group>
            </b-col>
          </b-row>
        </b-col>
        ...
        <b-col cols="6">
          <b-form-group :label="renderLabel({ label: 'status perkawinan' })" class="text-capitalize"
            ...
            <b-form-select :options="
              ...
              " :state="getDataError({ rawLabel: 'status perkawinan' })" :disabled="disabledForm()"
      ...
      <b-row>
        <b-col cols="6">
          <b-form-group label="Pekerjaan" class="text-capitalize" style="position: relative"
            :state="getDataError({ rawLabel: 'pekerjaan' })" :invalid-feedback="
              renderInvalidFeedback({
                validationDesc: blindlyGetData({
                  rawLabel: 'pekerjaan'
                })
            ...
            ">
            <vue-select taggable :options="jobs" @input="
                setValue({
                  rawLabel: 'pekerjaan',
                  $event
                })
              " :value="getValue('pekerjaan')" :disabled="disabledForm()" />
          </b-form-group>
        </b-col>
        <b-col cols="6" class="d-flex align-items-center justify-content-end">
          ...
          <template v-if="formType !== 'detail'">
            <b-button class="ml-3 text-uppercase" variant="primary" style="font-size:17.5px;" type="submit">simpan
            </b-button>
          </template>
          <template v-else>

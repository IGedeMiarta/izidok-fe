<template>
  <div>
    ...
    <div class="form-row">
      ...
      <div class="form-group col-md-6 pl-3">
        <label for="asuransi">Nama Penjamin/Asuransi</label>
        <input
          type="text"
          class="form-control"
          id="asuransi"
          name="asuransi"
          placeholder="Nama Penjamin/Asuransi"
        />
      </div>
    </div>
    <div class="form-row">
      ...
      <div class="col-md-6 pl-3">
        <div class="form-group">
          <label for="nomember">No. Member/Polis Asuransi</label>
          <input
            type="text"
            class="form-control"
            id="nomember"
            name="nomember"
            placeholder="No. Member/Polis Asuransi"
          />
        </div>
        <div class="form-group">
    ...
    <div class="form-row">
      ...
      <div class="form-group col-md-6 pl-3">
        <label for="nohppj">No. Hp Penanggung Jawab</label>
        <input
          type="text"
          class="form-control"
          id="nohppj"
          name="nohppj"
          placeholder="No. Hp Penanggung Jawab"
        />
      </div>
    </div>
    <b-row class="mb-3">
      <b-col cols="6">
        <b-row>
          ...
          <b-col cols="4">
            <label for="nohppj">Kecamatan</label>
            <input
              type="text"
              class="form-control"
              id="nohppj"
    ...
    <b-row>
      <b-col cols="6">
        ...
        <select id="inputState" class="form-control">
          ...
          <option value="1">Kerja Kerja</option>
        </select>
      </b-col>
